    ...
    return (
        <div className="flex flex-col p-4 rounded-lg shadow-md bg-white">
            ...
            <p className="mb-7">
                ...
                Temporibus cumque quod tempore cupiditate explicabo consequatur
                repellat fugit reprehenderit, perferendis assumenda.
            </p>
            ...
            <div className="flex gap-x-2 bg-transparent">
                {/* TODO: use icons */}
                <button className="flex-1 p-2 pb-3 rounded-md bg-gray-200 font-medium">
                    <BiLike
                        size="20px"
                        style={{
                            display: "inline",
